  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn(
          "rounded-none bg-[#FF385C]/10 text-[#FF385C] font-bold", 
        ...
        today: cn(
          "rounded-full bg-slate-100 text-slate-900 data-[selected=true]:bg-[#FF385C]",
          defaultClassNames.today
        ),
        outside: cn(
          "text-slate-300 aria-selected:text-slate-300 opacity-50",

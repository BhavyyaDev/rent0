...
export function HeroSearchForm() {
  ...
  return (
    <form 
      ...
      className="flex flex-col md:flex-row items-center gap-4 bg-white p-3 rounded-2xl border border-slate-200 shadow-md relative z-20 max-w-4xl mx-auto"
    >
      <div className="flex-1 w-full flex items-center gap-4 py-3 px-6 rounded-full bg-slate-50/50 border border-slate-200 group transition-all hover:bg-white hover:border-slate-300">
      ...
      <Button 
        type="submit"
        size="lg"
        className="w-full md:w-auto px-10 h-16 text-lg shadow-md flex items-center justify-center gap-2 group"
      >

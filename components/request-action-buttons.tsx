        ...
        return (
          <div className="flex flex-col gap-3">
            ...
            <Button
              ...
              disabled={isPending}
              className="bg-[#d4f07a] hover:bg-[#c8e86e] text-[#1a1a1a] rounded-full h-10 px-6 font-black text-[13px] shadow-lg hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
            >
        ...
        {status === 'pending' && (
          <>
            <Button
              ...
              disabled={isPending}
              className="flex-1 rounded-full h-12 font-black text-[13px] bg-[#d4f07a] text-[#1a1a1a] hover:bg-[#c8e86e] shadow-md hover:scale-105 transition-all duration-200 ease-in-out active:scale-95"
            >
              Approve Rental
            </Button>
            <Button
              ...
              disabled={isPending}
              className="px-4 rounded-full h-12 font-bold text-[13px] border border-red-400 text-red-500 bg-transparent hover:bg-red-50 transition-all duration-200 ease-in-out active:scale-95"
            >
              Decline
            </Button>
          </>
        ...
        {status === 'accepted' && (
          <div className="flex flex-col gap-2 w-full">
            ...
            <Button
              ...
              className="w-full rounded-full h-12 font-black text-[13px] bg-[#1a1a1a] text-white hover:bg-black shadow-md hover:scale-105 transition-all duration-200 ease-in-out active:scale-95 disabled:opacity-40"
            >
        ...
        {status === 'active' && (
          <div className="flex flex-col gap-2 w-full">
            ...
            <Button
              ...
              disabled={isPending}
              className="w-full bg-[#1a1a1a] text-white font-black rounded-full h-12 text-[13px] hover:bg-black hover:scale-105 transition-all duration-200 ease-in-out disabled:opacity-40 shadow-md active:scale-95"
            >
        ...
        <DialogContent className="max-w-[380px] rounded-2xl p-6">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <Button
              ...
              disabled={isPending}
              className="w-full bg-[#d4f07a] hover:bg-[#c8e86e] text-[#1a1a1a] font-black h-14 rounded-full shadow-md hover:scale-105 transition-all duration-200 ease-in-out active:scale-95"
            >
